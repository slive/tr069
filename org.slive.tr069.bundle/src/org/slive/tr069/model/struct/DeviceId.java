...
public class DeviceId extends AbstractStruct
{
    ...
    /**
     * 制造商标识固定名称，是{@link DEVICEID}的子元素，即xml文件<Manufacturer xsi:type="xsd:string[64]">GDT</Manufacturer>中的属性名
     */
    public static final String MANUFACTURER = "Manufacturer";
    /**
     * 制造商标识固定名称，是{@link DEVICEID}的子元素，即xml文件<OUI xsi:type="xsd:string[6]">123456</OUI>中的属性名
     */
    public static final String OUI = "OUI";
    /**
     * 设备类型标识固定名称，是{@link DEVICEID}的子元素，即xml文件<ProductClass xsi:type="xsd:string[64]">IGD</ProductClass>中的属性名
     */
    public static final String PRODUCTCLASS = "ProductClass";
    /**
     * 设备唯一标识固定名称，是{@link DEVICEID}的子元素，即xml文件<SerialNumber xsi:type="xsd:string[64]">AAAA-BBBB-CCCC-DDDD</SerialNumber>中的属性名
     */
    ...
    /**
     * 使用前确保所有的字段都初始化
     * {@linkplain AbstractStruct#addThisToBody(SOAPBodyElement, SOAPFactory)}
     */
    @Override
